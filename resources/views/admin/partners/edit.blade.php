                    ...
                    <div class="card-body">
                        <form id="edit-partner-form" action="{{ route('partners.update', $partner->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="ar_name" name="ar_name" value="{{ $partner->ar_name ?? "" }}">
                            </div>
                            <div class="mb-3">
                                <label for="ar_description" class="form-label">Arabic Description</label>
                                <div id="snow-editor2" style="height: 300px;">{!! $partner->ar_description ?? "" !!}</div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $('#edit-partner-form').on('submit', function(e) {
                ...
                $('#ar_description').val(ar_quillContent);
