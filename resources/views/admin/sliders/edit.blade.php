    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form id="edit-slider-form" action="{{ route('sliders.update', $slider->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mt-2" id="image-preview">
                                    <img src="{{ $slider->getFirstMediaUrl('images') }}" alt="Slider Image" style="max-width: 200px;">
                                </div>
                            </div>
            ...
            $('#edit-slider-form').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    error: function(response) {
                        ...
                        $.toast({
                            heading: 'Error',
                            text: 'There was an error updating the slider.',
                            icon: 'error',
                            loader: true,
                            loaderBg: '#f96868',
                            position: 'top-right',
