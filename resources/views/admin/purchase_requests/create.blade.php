@extends('layouts.vertical', ['page_title' => 'Create Purchase Request'])
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">Create Purchase Request</h4>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form id="create-purchase-request-form" action="{{ route('purchase-requests.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#create-purchase-request-form').on('submit', function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    error: function(response) {
                        $.toast({
                            heading: 'Error',
                            text: 'There was an error creating the purchase request.',
                            icon: 'error',
                            loader: true,
                            loaderBg: '#f96868',
                            position: 'top-right',
